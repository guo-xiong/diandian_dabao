...
print("Applovin")
newFile = path + "\\"+FFA_name+"_Applovin.html"
copy(indexFile,newFile)
replaceFile(newFile,branch_path + "log.txt",branch_path+"link.txt")

print("Facebook")
newFile = path + "\\"+FFA_name+"_Facebook\\index.html"
copy(indexFile,newFile)
copy(res,path + "\\"+FFA_name+"_Facebook\\res.js")
#删除第一个script
...
#添加压缩文件
create_zip_with_files(path + "\\"+FFA_name+"_Facebook.zip", [newFile,path + "\\"+FFA_name+"_Facebook\\res.js"])

print("Google")
newFile = path + "\\"+FFA_name+"_Google\\index.html"
copy(indexFile,newFile)
...
#添加压缩文件
create_zip_with_files(path + "\\"+FFA_name+"_Google.zip", [newFile])

print("Ironsource")
newFile = path + "\\"+FFA_name+"_Ironsource.html"
copy(indexFile,newFile)
...
print("Liftoff")
newFile = path + "\\"+FFA_name+"_Liftoff\\index.html"
copy(indexFile,newFile)
replaceFile(newFile,branch_path + "log.txt",branch_path+"link.txt")
#添加压缩文件
create_zip_with_files(path + "\\"+FFA_name+"_Liftoff.zip", [newFile])

print("Moloco")
newFile = path + "\\"+FFA_name+"_Moloco.html"
copy(indexFile,newFile)
